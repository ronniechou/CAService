...
# CC Compiler Flags
CCFLAGS=-m32 -Wall -MMD -Wshadow -Wno-write-strings -Wno-deprecated
CXXFLAGS=-m32 -Wall -MMD -Wshadow -Wno-write-strings -Wno-deprecated
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../Release/linux/CAService/CAService

../Release/linux/CAService/CAService: ../Speedy/Release/linux/UFC.a

../Release/linux/CAService/CAService: ${OBJECTFILES}
	${MKDIR} -p ../Release/linux/CAService
	${LINK.cc} -o ../Release/linux/CAService/CAService ${OBJECTFILES} ${LDLIBSOPTIONS} /usr/local/lib/libcurl.a /usr/local/lib/libssh2.a /usr/lib/libssl.a -lrt -lcrypto -lgssapi_krb5
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../Release/linux/CAService/CAService
